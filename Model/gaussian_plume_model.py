...
if __name__ == "__main__":
    ...
    WIND_DIRECTION = 60 # Направление ветра в градусах (Относительно оси X)
    ...
    SOURCE_POSITIONS = [(0, 0, 0),   (29, -34.5, 0),
                        (76, 57, 0), (105, 22.5, 0), (134, -12, 0), (163, -46.5, 0),
                        (195, 90.5, 0), (224, 56, 0), (253, 21.5, 0)]

    # Параметры сетки
    DOMAIN_SIZE_X = 3000  # Размер области по x (м)
    DOMAIN_SIZE_Y = 500  # Размер области по y (м)
    NUM_POINTS = 1000  # Количество точек для построения
